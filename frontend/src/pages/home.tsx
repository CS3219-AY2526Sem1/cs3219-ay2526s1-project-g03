      ...
      <main className="home-main">
        <section className="main-section">
          ...
          <p className="main-description">
            Practice coding interviews with peers worldwide. Get matched with partners,
            solve problems together, and improve your skills in real-time
          </p>
          <Link to="/login" className="cta-button">Start Practicing</Link>
        </section>
